...
const productsData = [
    {
        ...
        images: [
            "images/grua todo terreno broderson rt-300-2c.png",
            "images/Grúa Todo Terreno Grove RT700E.png",
            "images/Grúa Todo Terreno Terex RT 110.png"
        ],
        isCrane: true,
        cranes: [
            {
    ...
    },
    {
        ...
        images: [
            "images/Filtros de carbon.png",
            "images/Filtros de agua cruda.png",
            "images/Filtro coalescedor de gas inoxidable.png",
            "images/Filtro coalescedor de gas combustible.png",
        ],
        features: [
    ...
    },
    {
        ...
        images: [
            "images/Tanques.png",
            "images/Separador de desfogues de baja presion.png",
            "images/Separador de desfogues de alta presión.png",
        ],
        features: [
    ...
    nav.innerHTML = `
        <nav class="fixed top-0 w-full z-50 transition-all duration-300 py-4 bg-white/80 backdrop-blur-md border-b border-transparent shadow-sm" id="nav-inner">
            <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
                <a href="#"><img src="images/Cerberologo.png" alt="Logo" class="h-12 w-auto"></a>
...
function renderFooter() {
    ...
    footer.innerHTML = `
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-10">
            <img src="images/CerberoLogo.png" alt="Logo" class="h-16 w-auto opacity-50 grayscale">
